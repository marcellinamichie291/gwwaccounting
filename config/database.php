    ...
    */
    ...
    'connections' => [
        ...
        'galaxy_db' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_GALAXY', '127.0.0.1'),
            'port' => env('DB_PORT_GALAXY', '3306'),
            'database' => env('DB_DATABASE_GALAXY', 'forge'),
            'username' => env('DB_USERNAME_GALAXY', 'forge'),
            'password' => env('DB_PASSWORD_GALAXY', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
